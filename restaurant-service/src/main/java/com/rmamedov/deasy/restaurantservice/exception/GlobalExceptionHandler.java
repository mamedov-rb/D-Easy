package com.rmamedov.deasy.restaurantservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<ResponseModel>> handleMenuPositionNotFoundException(final MenuPositionNotFoundException ex) {
        log.error("MenuPositionNotFoundException: ", ex);
