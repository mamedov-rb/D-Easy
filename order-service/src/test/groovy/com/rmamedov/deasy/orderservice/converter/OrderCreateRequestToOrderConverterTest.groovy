...
import static com.rmamedov.deasy.orderservice.util.ModelHelper.CONSUMER_ADDRESS
import static com.rmamedov.deasy.orderservice.util.ModelHelper.ORDER_DESCRIPTION
import static com.rmamedov.deasy.orderservice.util.ModelHelper.ORDER_NAME
import static com.rmamedov.deasy.orderservice.util.ModelHelper.RESTAURANT_ADDRESS
import static com.rmamedov.deasy.orderservice.util.ModelHelper.orderCreateRequest
import static com.rmamedov.deasy.orderservice.util.ModelHelper.position1
import static com.rmamedov.deasy.orderservice.util.ModelHelper.position2
import static com.rmamedov.deasy.orderservice.util.ModelHelper.position3
