...
import com.rmamedov.deasy.orderservice.kafka.sender.KafkaSenderOrderInProgress;
...
public class OrderService {
    ...
    private final KafkaSenderOrderInProgress kafkaSenderOrderInProgress;
    ...
    public Mono<Order> create(final Order order) {
        return orderRepository.save(order)
                .flatMap(saved -> {
                    kafkaSenderOrderInProgress.send(orderToOrderMessageConverter.convert(saved));
